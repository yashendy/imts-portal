...
document.getElementById("search-btn").addEventListener("click", async () => {
    ...
    try {
        ...
        if (docSnap.exists()) {
            ...
            // تحديد المواد والدرجات النهائية
            let subjects = [
                ...
                { n: "الدراسات الاجتماعية", v: d.Social, m: 20 },
                { n: isLang ? "ICT" : "تكنولوجيا المعلومات", v: d.technology, m: 15 }
            ];

            // إزالة التربية الدينية للمسيحيين
            if (d.rel_type === "مسيحي") {
...
// --- التعديل المفقود: تفعيل زر الطباعة ---
