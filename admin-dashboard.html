...
<body>
  <header class="topbar">
    ...
    <div class="top-actions">
      ...
      <button id="btnSignOut" class="btn danger" type="button">خروج</button>
    </div>
  </header>

  <!-- أزرار التبويبات (كلها type="button") -->
  <nav class="tabs">
    <button class="nav active" type="button" data-tab="overview">نظرة عامة</button>
    <button class="nav" type="button" data-tab="classes">الفصول</button>
    <button class="nav" type="button" data-tab="teachers">المعلّمون</button>
    <button class="nav" type="button" data-tab="link">الربط (معلّم ← فصل ← مادة)</button>
    <button class="nav" type="button" data-tab="subjects">المواد</button>
    <button class="nav" type="button" data-tab="students">الطلاب</button>
    <button class="nav" type="button" data-tab="timetable">الجدول</button>
    <button class="nav owner-only" type="button" data-tab="invites" style="display:none">الدعوات</button>
    <button class="nav owner-only" type="button" data-tab="settings" style="display:none">الإعدادات</button>
  </nav>
    ...
    <section class="tab" id="tab-classes">
      <div class="card">
        ...
        <div class="grid">
          ...
          <input id="cNameAr" class="input" placeholder="الاسم العربي للفصل">
          <input id="cCapacity" class="input" type="number" value="40" min="10" max="60" />
          <button id="btnCreateClass" class="btn primary" type="button">حفظ/إضافة فصل</button>
        </div>
        <p class="hint">المعرّف يكون مثل g4-lang-B، والاسم العربي للعرض فقط.</p>
      </div>
    ...
    <section class="tab" id="tab-teachers">
      <div class="card">
        <div class="toolbar">
          ...
          <button id="btnReloadTeachers" class="btn" type="button">تحديث</button>
        </div>
        <table class="table" id="teachersTable">
          <thead><tr>
            <th>الاسم</th><th>البريد</th><th>الحالة</th><th>الدور</th>
          </tr></thead>
          <tbody></tbody>
        </table>
      </div>
    ...
    <section class="tab" id="tab-link">
      <div class="card">
        <div class="grid">
          ...
          <button id="btnLink" class="btn primary" type="button">ربط المعلّم</button>
        </div>
      </div>
    </section>
    ...
    <section class="tab" id="tab-subjects">
      <div class="card">
        <div class="grid">
          ...
          <input id="subjId" class="input" placeholder="subjectId (مثال: arabic-g10 أو arabic-g10-ar)">
          ...
          <button id="btnCreateSubject" class="btn primary" type="button">حفظ/إضافة مادة</button>
        </div>
      </div>
      ...
      <div class="card">
        <div class="toolbar">
          ...
          <button id="btnReloadSubjects" class="btn" type="button">تحديث</button>
        </div>
    ...
    <section class="tab" id="tab-students">
      <div class="card">
        <div class="toolbar">
          ...
          <button id="btnReloadStudents" class="btn" type="button">تحديث</button>
        </div>
    ...
    <section class="tab" id="tab-timetable">
      <div class="card">
        <div class="grid">
          ...
          <button id="btnTTLoad" class="btn primary" type="button">تحميل الجدول</button>
        </div>
      </div>
      <div class="card">
        <div id="ttGrid"></div>
    ...
    <section class="tab" id="tab-invites">
      <div class="card owner-only" style="display:none">
        <div class="grid">
          ...
          <button id="btnCreateInvite" class="btn primary" type="button">إنشاء دعوة</button>
        </div>
      </div>
      <div class="card owner-only" style="display:none">
        <table class="table" id="invTable">
          <thead><tr><th>الكود</th><th>الدور</th><th>ينتهي</th><th>نشط</th></tr></thead>
          <tbody></tbody>
        </table>
      </div>
    </section>
    ...
    <section class="tab" id="tab-settings">
      <div class="card owner-only" style="display:none">
        <div class="grid">
          ...
          <button id="btnSaveSettings" class="btn primary" type="button">حفظ الإعدادات</button>
          <button id="btnRunSeed" class="btn secondary" type="button">تشغيل التهيئة</button>
        </div>
      </div>
    </section>
  </main>
